...
async def thumb_init(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "VAIBHAV MUSIC", fill="red", font = font1, align ="left") 
            image4.text((670, 150), "VAIBHAV PLAYER", fill="red", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
