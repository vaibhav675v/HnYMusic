...
from HnYMusic import BOT_NAME, app, db_mem, Ass
from HnYMusic.Helpers.PyTgCalls import Queues
from HnYMusic.Helpers.PyTgCalls.Converter import convert
from HnYMusic.Helpers.PyTgCalls.Downloader import download
from HnYMusic.Helpers.Database import remove_active_chat
from HnYMusic.Helpers.Inline import primary_markup
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = f"HnYMusic/Cache/{_path_}.jpg"
                    buttons = primary_markup(
                        videoid, "283402"
                    )
                finaltext = await app.send_photo(
