...
from HnYMusic.Helpers.Changers import *
from HnYMusic.Helpers.Clients import app, Ass
...
async def fallen_boot():
    ...
    with console.status(
        "[magenta] Booting HnY Music Bot...",
    ) as status:
        console.print("┌ [red]Booting HnY Music Clients...\n")
        await app.start()
        await Ass.start()
        console.print("└ [green]Clients Booted Successfully!")
        initial = await startup_msg("**» ʙᴏᴏᴛɪɴɢ ʜɴʏ ᴍᴜꜱɪᴄ ʙᴏᴛ...**")
