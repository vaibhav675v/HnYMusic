...
from HnYMusic.Cache.checker import checkerCB
from HnYMusic.Cache.admins import AdminRightsCheck, AdminRightsCheckCB
from HnYMusic.Helpers.Thumbnails import thumb_init
from HnYMusic.Helpers.Ytinfo import get_yt_info_id
from HnYMusic.Helpers.PyTgCalls import Queues, Fallen
from HnYMusic.Helpers.Changers import time_to_seconds
from HnYMusic.Helpers.PyTgCalls.Converter import convert
from HnYMusic.Helpers.PyTgCalls.Downloader import download
from HnYMusic import BOT_USERNAME, BOT_NAME, app, db_mem
from HnYMusic.Helpers.Inline import (audio_markup, primary_markup, close_key)
from HnYMusic.Helpers.Database import (add_active_chat, is_active_chat, remove_active_chat, is_music_playing, music_off, music_on)
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = "HnYMusic/Utilities/Audio.jpeg"
                    aud = 1
                else:
                    _path_ = _path_ = (
                        (str(afk))
                    ...
                    thumb = f"HnYMusic/Cache/{_path_}final.png"
                    buttons = primary_markup(
                        videoid,
                        CallbackQuery.from_user.id,
                    )
