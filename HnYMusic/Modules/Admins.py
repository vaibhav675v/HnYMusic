...
from HnYMusic import BOT_NAME, app, db_mem
from HnYMusic.Cache.admins import AdminRightsCheck
from HnYMusic.Cache.checker import checker, checkerCB
...
from HnYMusic.Helpers.Inline import primary_markup, close_key, audio_markup
from HnYMusic.Helpers.Database import (is_active_chat, is_music_playing, music_off,
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = f"HnYMusic/Cache/{_path_}.png"
                    buttons = primary_markup(
                        videoid,
                        message.from_user.id,
                    )
