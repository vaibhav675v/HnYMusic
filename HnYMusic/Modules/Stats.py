...
from HnYMusic import (BOT_NAME, SUDO_USERS, app, Ass, StartTime, MONGO_DB_URI)
from HnYMusic.Helpers.Database import get_gbans_count, get_served_chats, get_served_users
from HnYMusic.Helpers.Inline import stats_f, stats_b
...
async def gstats(_, message):
    ...
    hehe = await message.reply_photo(
        photo="HnYMusic/Utilities/Stats.jpeg", caption=f"**» ᴩʟᴇᴀsᴇ ᴡᴀɪᴛ...\n\n• ɢᴇᴛᴛɪɴɢ {BOT_NAME} sᴛᴀᴛs...**"
    )
    smex = f"""
